...
complex_reward_after_free_rays_path = 'outputs/rl_models/daniel/punish_miss_free_rays/obs500k9.zip'

complex_reward_path = 'outputs/rl_models/jan/complex_reward/obs500k9.zip'
complex_reward_diff_path = 'outputs/rl_models/jan/complex_reward_diff/rew500k9.zip'
...
trial_path = 'src/neural_nets/best_trial.pkl'
rec_net_path = 'src/neural_nets/trained_rec.pkl'
...
while iter < num_samples:
    ...
    plt.savefig("outputs/plots_plakat/temp/rl_plots/"+name + '/iter_%i_step_%i_gp%i.png' %(iter,step,gps))
    step += 1
