...
########################################
from src.data_preprocessing.model_classes import *
...
class DataConverter:
    ...
    input_path = './data/3D_shapes'
    output_path = './data/2D_shapes'
...
# run this line to see whether you can download the data_preprocessing from shapenet and display the files correctly
